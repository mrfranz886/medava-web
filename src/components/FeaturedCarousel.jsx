      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        >
            {[...medavaProEquipment, ...medavaProEquipment].map((item, index) => (
              <div
                key={`${item.id}-${index}`}
                className="relative flex-shrink-0 w-[350px] rounded-3xl overflow-hidden bg-white border border-gray-100 shadow-lg hover:shadow-2xl hover:-translate-y-1 transition-all duration-300"
